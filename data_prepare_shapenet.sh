...
then
	...
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/test/real_dataset/couch/real_50_25d_vox256  -tv /media/wangyida/D0-P1/database/RecGAN_Yida/test/depth_tsdf_npy -c 1 &
