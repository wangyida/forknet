...
then
	...
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/P1_03001627_chair/train_25d_vox256  -tv /media/wangyida/D0-P1/database/Shapenet_Yida/train/depth_tsdf_npy -c 2 &
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/P1_04256520_coach/train_25d_vox256  -tv /media/wangyida/D0-P1/database/Shapenet_Yida/train/depth_tsdf_npy -c 3 &
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/P1_04379243_table/train_25d_vox256  -tv /media/wangyida/D0-P1/database/Shapenet_Yida/train/depth_tsdf_npy -c 4 &
	...
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/P1_03001627_chair/test_25d_vox256  -tv /media/wangyida/D0-P1/database/Shapenet_Yida/test/depth_tsdf_npy -c 2 &
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/P1_04256520_coach/test_25d_vox256  -tv /media/wangyida/D0-P1/database/Shapenet_Yida/test/depth_tsdf_npy -c 3 &
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/P1_04379243_table/test_25d_vox256  -tv /media/wangyida/D0-P1/database/Shapenet_Yida/test/depth_tsdf_npy -c 4 &
...
then
	...
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/test/real_dataset/chair/real_50_25d_vox256  -tv /media/wangyida/D0-P1/database/RecGAN_Yida/test/depth_tsdf_npy -c 2 &
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/test/real_dataset/couch/real_50_25d_vox256  -tv /media/wangyida/D0-P1/database/RecGAN_Yida/test/depth_tsdf_npy -c 3 &
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/test/real_dataset/table/real_50_25d_vox256  -tv /media/wangyida/D0-P1/database/RecGAN_Yida/test/depth_tsdf_npy -c 4 &
	...
	python2 data/rescaling.py -s /media/wangyida/D0-P1/database/data_3drecgan++/test/real_dataset/couch/real_50_3d_vox256  -tv /media/wangyida/D0-P1/database/RecGAN_Yida/test/voxel_semantic_npy -c 3 &
