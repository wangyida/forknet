...
python3 visualization/voxviz.py -v ./eval/tsdf.npy -t vis_real_tsdf &
...
python3 visualization/voxviz.py -v ./eval/recons_tsdf.npy -t vis_recons_tsdf &
python3 visualization/voxviz.py -v ./eval/vae_tsdf.npy -t vis_vae_tsdf &
python3 visualization/voxviz.py -v ./eval/cc_tsdf.npy -t vis_cc_tsdf &
wait
