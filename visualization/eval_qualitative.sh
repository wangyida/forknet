...
then
	...
	python3 visualization/voxviz.py -v ./eval_suncg/recons_vox.npy -t vis_suncg/scene_3dgan -n 12 &
	# python3 visualization/voxviz.py -v ./eval_suncg/recons_tsdf.npy -t vis_suncg/tsdf_recons -n 3 &
	python3 visualization/voxviz.py -v ./eval_suncg/recons_refine_vox.npy -t vis_suncg/scene_ours_wo-refiner -n 12 &
	python3 visualization/voxviz.py -v ./eval_suncg/vae_vox.npy -t vis_suncg/scene_ours -n 12 &
	python3 visualization/voxviz.py -v ./eval_suncg/cc_vox.npy -t vis_suncg/scene_ours_wo-styletrans -n 12 &
...
then
	...
	python3 visualization/voxviz.py -v ./eval_nyu/recons_vox.npy -t vis_nyu/scene_3dgan -n 12 &
	# python3 visualization/voxviz.py -v ./eval_nyu/recons_tsdf.npy -t vis_nyu/tsdf_recons -n 3 &
	python3 visualization/voxviz.py -v ./eval_nyu/recons_refine_vox.npy -t vis_nyu/scene_ours_wo-refiner -n 12 &
	python3 visualization/voxviz.py -v ./eval_nyu/vae_vox.npy -t vis_nyu/scene_ours -n 12 &
	python3 visualization/voxviz.py -v ./eval_nyu/cc_vox.npy -t vis_nyu/scene_ours_wo-styletrans -n 12 &
...
then
	...
	python3 visualization/voxviz.py -v ./eval_shapenet/recons_vox.npy -t vis_shapenet/scene_3dgan -n 4 &
	# python3 visualization/voxviz.py -v ./eval_shapenet/recons_tsdf.npy -t vis_shapenet/tsdf_recons -n 3 &
	python3 visualization/voxviz.py -v ./eval_shapenet/recons_refine_vox.npy -t vis_shapenet/scene_ours_wo-refiner -n 4 &
	python3 visualization/voxviz.py -v ./eval_shapenet/vae_vox.npy -t vis_shapenet/scene_ours -n 4 &
